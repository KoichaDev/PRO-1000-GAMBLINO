...
import InspectorControlsImage from "../block-inspector-controls/ControlsImage";
import BlockControlsMediaReplaceFlow from "../block-controls/BlockControlsMediaReplaceFlow";

const BlockMediaPlaceholder = ({ id, url, alt, noticeUI, setAttributes }) => {
...
export default BlockMediaPlaceholder;
